...
<form action="" method="POST" class="ctn-container">
    ...
    <div class="right-side">
        ...
        <div class="schedule">
            <div class="dates">
                <a href= "{{route('info',["Name" => $movie[0]->Name,"Day" => "1stDay"])}}" class="datee">
                    <span class="day"><?php echo date("d")?></span>
                    <span class="month">/<?php echo date("m")?> - <?php echo date("D")?></span>
                </a>
                <a href= "{{route('info',["Name" => $movie[0]->Name,"Day" => "2ndDay"])}}" class="datee">
                ...
                <a href= "{{route('info',["Name" => $movie[0]->Name,"Day" => "3rdDay"])}}" class="datee">
