...
<section class="container-header">
    <header class="header">
        ...
        <div class="nav-bar">
            ...
            <nav class="switch">
                <a class="a-sw" href="{{Cookie::has('isAdmin')?route('adminHome'):route('home')}}">Trang chủ</a>
                <a class="a-sw" href="{{Cookie::has('isAdmin')?route('adminFilm',["Film" => "coming"]):route('film',["Film" => "coming"])}}">Phim</a>
                <a class="a-sw" href="{{Cookie::has('isAdmin')?route('adminPromotion'):route('promotion')}}">Ưu đãi - Sự kiện</a>
            </nav>
            @if(Cookie::has('isAdmin'))
            <div class="userBox remain" >
                <a href="{{route("adminMember")}}" class='sign-box' style="text-decoration: none; color: var(--1st-color);" href="">
            ...
            <div class="userBox remain" >
                <a href="{{route("member")}}" class='sign-box' style="text-decoration: none; color: var(--1st-color);" href="">
                    <img class="avatar" width="100%" src="{{asset("img/avatar.jpg")}}" >
                    <div>User</div>  
               </a>             
            </div>
...
<script src="{{url('js/isActive.js')}}" type="text/javascript" async></script>
@endpush